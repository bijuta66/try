	 ...
	 int baseX = 125;
	    ...
	    public AddDeviceUI(String[] oldData) {
	        ...
	        btnSave.addActionListener(e -> {
	            ...
	            if (name.isEmpty()) {
	                JOptionPane.showMessageDialog(frame, "Please fill device name.");
	            } else if (checkDeviceName(name)) {
	                JOptionPane.showMessageDialog(frame, "Your device name should be unique.");
	            } else if (port.isEmpty()) {
	                JOptionPane.showMessageDialog(frame, " Please fill device port.");
	            } else if (type.isEmpty()) {
	                JOptionPane.showMessageDialog(frame, "Please fill device type.");
	            } else {

...
public class Device {
    ...
    public static void main(String[] args) {
        ...
        d.deviceGraph.shortestPath(0, 9);
    }

    public String[] findShortestPath(String from, String to) {
        int[] path = this.deviceGraph.shortestPath(Integer.parseInt(convertNameToId(from)),
    ...
    public String updateDevice(String changedData[]) {
        return fh.UpdateFile(Constants.deviceDetailFileName, changedData);
    }
